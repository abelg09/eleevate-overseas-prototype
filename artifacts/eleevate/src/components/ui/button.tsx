    ...
    variants: {
      variant: {
        default:
           ...
           "brand-gradient-bg text-primary-foreground border border-transparent shadow-sm",
        destructive:
        ...
        outline:
          ...
          // No hover state
          " border bg-card/70 [border-color:var(--button-outline)] shadow-xs active:shadow-none ",
        secondary:
