...
const DEMO_LOYALTY: LoyaltyData = {
  ...
  ledger: [
    { id: "demo-loyalty-1", userId: "demo-student", event: "profile_completed", points: 100, description: "Completed EDGE+ profile", createdAt: "2026-05-15T09:00:00.000Z" },
...
export default function RewardsPage() {
  ...
  const referralCode = demoMode ? "AARAV2026" : user?.id ? user.id.slice(-8).toUpperCase() : "--------";
