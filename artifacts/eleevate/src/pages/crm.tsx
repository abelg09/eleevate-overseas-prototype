...
const DEMO_LEADS: Lead[] = [
  { id: "demo-lead-aarav", studentName: "Aarav Mehta", email: "aarav.mehta@example.com", phone: "+91 98765 43210", status: "active_client", source: "website", targetCountry: "Canada", targetDegree: "MSc Computer Science", notes: "EDGE+ score 82. Finance docs need review.", followUpAt: "2026-05-29T10:00:00.000Z", createdAt: "2026-05-18T10:00:00.000Z" },
...
function LeadDetailDrawer({ lead, onClose, onUpdate, demoMode }: { lead: Lead; onClose: () => void; onUpdate: () => void; demoMode?: boolean }) {
  ...
  const leadDetail = demoMode
    ? {
      ...lead,
      activities: [
        { id: `${lead.id}-activity-1`, type: "note", message: "EDGE+ readiness reviewed and next best action assigned.", createdAt: "2026-05-21T09:00:00.000Z" },
