  ...
  return (
    <div data-testid="news-newsletter-page">
      <PageHeader
        ...
        description="A curated update layer for visa changes, admission deadlines, scholarships, job market signals, and newsletter campaigns. Live feeds can be connected later."
        actions={
